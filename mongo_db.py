...
if __name__ == "__main__":
    ...
    # 拿到所有符合同今日日期的 symbols
    docs = db_handler.find_doc("fundamentals_of_top_list_symbols", {"today_date": today_str})
    ...
    # 假設 docs 是你查詢到的文件列表
    filtered_docs = [d for d in docs if d.get("symbol", "").lower() == symbol.lower()]
